...
const CategoriesAdmin = () => {
  ...
  const fetchCategories = async () => {
    try {
      const res = await fetch('https://hi-techserver-zd1d.onrender.com/api/categories');
  ...
  const deleteCategory = async (id) => {
    ...
    try {
      const res = await fetch(`https://hi-techserver-zd1d.onrender.com/api/categories/${id}`, { method: 'DELETE' });
  ...
  const toggleStatus = async (id, field, currentValue) => {
    try {
      const res = await fetch(`https://hi-techserver-zd1d.onrender.com/api/categories/${id}`, {
        method: 'PUT',
